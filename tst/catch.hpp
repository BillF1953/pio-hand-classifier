...
#ifndef HANDCLASSIFIER_CATCH_H
#define HANDCLASSIFIER_CATCH_H
/*
 *  Catch v2.9.1
...
#else
CATCH_ERROR( "tst failure requires aborting test!" );
#endif
}
}
...
<< std::left << std::setw(16) << "framework: " << "Catch tst\n"
...
m_filters.push_back(""); // tst Case - not a section filter
